...
3. Verify the new account Insights journey against the authorized live Instagram
   account after the exact candidate is deployed. The local mock is not evidence
   of a provider grant.
